...
export default function ChatContainer({
	...
	//console.log(`group message database : ${JSON.stringify(groupMessages)}`);

	//Join room and receiving the messages on socket(group)
	...
	//console.log(` group message arrival ${arrivalGroupMessage}`);
	//receiving messages on socket(single chat)
	useEffect(() => {
		if (socket.current) {
